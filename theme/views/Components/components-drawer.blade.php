...
<html lang="en">
  <head>
    ...
    <title>Lineone - Drawer Component</title>
  ...
  >
    ...
    >
      ...
      <div
        ...
        @show-drawer.window="($event.detail.drawerId === 'left-drawer') && (showDrawer = true)"
      ...
      <div
        x-show="showDrawer"
        x-data="{showDrawer:false}"
        @show-drawer.window="($event.detail.drawerId === 'right-drawer') && (showDrawer = true)"
        @keydown.window.escape="showDrawer = false"
      >
        <div
          class="fixed inset-0 z-[100] bg-slate-900/60 transition-opacity duration-200"

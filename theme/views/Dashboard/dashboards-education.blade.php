...
<html lang="en">
  <head>
    ...
    <title>Lineone - Education Dashboard</title>
          ...
          >
            <div class="swiper-wrapper">
              ...
              >
                ...
                <div class="mt-6">
                  <div
                    x-tooltip.warning="'50% Completed'"
                    class="progress h-1 bg-slate-150 dark:bg-navy-500"
                  >
        ...
        >
          <div class="card col-span-12 pb-3 lg:col-span-6">
            ...
            <div class="course-schedule-chart pr-2">
              <div
                x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.courseTimeline); $el._x_chart.render() });"
              ></div>
            </div>
          </div>
          <div

...
<html lang="en">
  <head>
    ...
    <title>Lineone - Authors Dashboard</title>
        ...
        >
          ...
          <div class="card">
            ...
            <div class="ax-transparent-gridline">
              <div
                x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogVisitors); $el._x_chart.render() });"
              ></div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="ax-transparent-gridline">
              <div
                x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogMembers); $el._x_chart.render() });"
              ></div>
            </div>
          </div>
        </div>
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div
                        ...
                        x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors1); $el._x_chart.render() });"
                      ></div>
                    </div>
                ...
                <div class="px-4 py-2 sm:px-5">
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div
                        class="ax-transparent-gridline"
                        x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors2); $el._x_chart.render() });"
                      ></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p
                ...
                <div class="px-4 py-2 sm:px-5">
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div
                        class="ax-transparent-gridline"
                        x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors3); $el._x_chart.render() });"
                      ></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p
                ...
                <div class="px-4 py-2 sm:px-5">
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div
                        class="ax-transparent-gridline"
                        x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors4); $el._x_chart.render() });"
                      ></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p

            ...
            <div class="card p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p class="text-xs+"> {{auth()->user()->occupation}}</p>
                </div>
              </div>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        <div class="avatar mt-1.5 h-20 w-20">
                            ...
                            <input type="file" id="actual-btn" name="profile_photo" accept="image/*" onchange="showPreview(event);" hidden/>
                             
                            <label
                                for="actual-btn"
                                class="btn h-6 w-6 rounded-full border border-slate-200 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 
                                active:bg-slate-300/25 dark:border-navy-500 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                              @if(auth()->user()->occupation == 'not set')
                                <input
                                class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="not set"
                                type="text"
                        ...
                        {{-- <label class="block">
                            <textarea
                              rows="4"
                              placeholder="{{auth()->user()->about?'':'Not Set'}}"

...
<html lang="en">
  <head>
    ...
    <title>Lineone - Price List Page v3</title>
  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-1"
          >
            <div
            ...
            >
              ...
              <div class="mt-5">
                <span
                  class="text-4xl tracking-tight text-secondary dark:text-secondary-light"
                  >$5</span
                >/month
              </div>
          ...
          >
            <div
              class="relative rounded-xl bg-slate-50 p-4 text-center dark:bg-navy-900 sm:p-5"
            >
          ...
          >
            ...
            >
              ...
              <div class="mt-5">
                <span class="text-4xl tracking-tight text-warning">$25</span
                >/month
              </div>
              <div class="mt-8 space-y-4 text-left">
                <div class="flex items-start space-x-3">
